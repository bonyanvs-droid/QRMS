...
export function createApp() {
  ...
  app.use((req, res, next) => {
    res.setHeader(
      ...
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: data: https://accounts.google.com https://apis.google.com https://www.googletagmanager.com https://www.gstatic.com https://aistudio.google.com; " +
      "worker-src 'self' blob: data: https://aistudio.google.com https://www.gstatic.com; " +
