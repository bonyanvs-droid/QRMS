...
export const INITIAL_EDUCATIONAL_PLAN: EducationalPlanWeek[] = [
  ...
  },
  {
    ...
    endDate: '2026-09-10',
    educationalGoal: 'إتقان الصلاة وتدبر سورة الفاتحة وأركان الركوع والسجود',
    motto: '«صلاتي قرة عيني»',
    responsiblePerson: 'أ. صالح بشير',
    budget: 600,
    activity: 'المصلى التعليمي التفاعلي ومسابقة أجمل أذان وأخشع صلاة',
    executionStatus: 'in_progress',
    notes: 'الأسبوع الحالي قيد التنفيذ مع قياس أثر نطق الفاتحة في الصلاة',
  },
  {
    id: 'edu_w7',
    weekNumber: 7,
