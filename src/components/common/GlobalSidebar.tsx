...
export const GlobalSidebar: React.FC<GlobalSidebarProps> = ({
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full select-none overflow-y-auto pb-4">
  ...
  return (
    <aside
      className={`hidden lg:flex flex-col w-64 xl:w-72 shrink-0 bg-white border-l border-slate-200 sticky top-16 h-[calc(100vh-4rem)] z-20 ${className}`}
    >
      {sidebarContent}
    </aside>
  );
