...
function buildMock527Backup() {
  const collections: Record<string, any[]> = {
    ...
    academic_years: [{ id: 'ay_1446', yearName: '1446-1447هـ' }],
    financial_records: [{ id: 'fin_rec_1', studentId: 'std_test_1', amount: 500 }],
    budget_requests: [{ id: 'bud_req_1', title: 'Operational Budget', amount: 10000 }],
    registration_requests: [{ id: 'reg_req_1', applicantName: 'Applicant 1' }],
    prayer_times: [{ id: 'pt_1', date: '2026-09-17' }],
    frontendConfigs: [{ id: 'fec_1', themeName: 'default' }],
